...
INSERT OR IGNORE INTO lineIO(pkey,active,carrier,closeroute,cluster,desc,moh,monitor,openroute,peername,routeclassopen,routeclassclosed,swoclip,technology) values ('_XXXX.','YES','PTT_DiD_Class','Operator','default','user1804','NO','Operator','peer1798','100','100','NO','Class');
