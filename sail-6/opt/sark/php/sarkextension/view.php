...
private function showMain() {
	...
	$res = $this->dbh->query("SELECT CLUSTER,SIPDRIVER FROM globals")->fetch(PDO::FETCH_ASSOC);
	$cluster = $res['CLUSTER'];
	$sipdriver = $res['SIPDRIVER'];
	$extensions = $this->helper->getTable("ipphone");
...
private function showEdit() {
	...
	$res = $this->dbh->query("SELECT FQDN,VXT,SIPDRIVER FROM globals ")->fetch(PDO::FETCH_ASSOC);
	$sipdriver = $res['SIPDRIVER'];
	$fqdn = $res['FQDN'];
	$vxt = $res['VXT'];

	$extension = $this->helper->getTable("ipphone");
